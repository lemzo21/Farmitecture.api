...
namespace Farmitecture.Api.Utils;

public static class PaginationHelper
{
    public static async Task<PagedResult<IEnumerable<TDto>>> GetPaginatedResultAsync<TEntity, TDto>(
        ...
        where TEntity : class
    {
        ...
        return new PagedResult<IEnumerable<TDto>>
        {
            Data = dto,
            PageIndex = page,
